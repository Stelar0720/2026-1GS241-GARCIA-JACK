...
- **MCP** (Model Context Protocol): 14 tools, cada una con un permiso; el servidor resuelve su rol vía `/auth/whoami` y el backend valida la API key (`Authorization: Bearer`).
